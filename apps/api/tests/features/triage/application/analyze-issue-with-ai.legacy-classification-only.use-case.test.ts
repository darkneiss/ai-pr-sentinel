...
describe('AnalyzeIssueWithAiUseCase (legacy classification-only response)', () => {
  it('should normalize legacy classification-only response and create question comment', async () => {
    // Arrange
